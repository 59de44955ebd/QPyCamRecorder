...
IFontDisp = Font
__all__ = [ 'IPicture', 'OLE_CANCELBOOL', 'FONTSTRIKETHROUGH',
           'StdPicture', 'OLE_YPOS_PIXELS', 'Default',
           'OLE_YSIZE_PIXELS', 'FONTUNDERSCORE', 'FONTBOLD',
           'FONTNAME', 'OLE_COLOR', 'OLE_XSIZE_PIXELS',
           'OLE_XSIZE_CONTAINER', 'OLE_YPOS_CONTAINER', 'Unchecked',
           'VgaColor', 'LoadPictureConstants', 'FONTSIZE', 'StdFont',
           'OLE_XPOS_PIXELS', 'OLE_TRISTATE', 'Picture', 'FontEvents',
           'OLE_YPOS_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'OLE_OPTEXCLUSIVE', 'Monochrome', 'FONTITALIC',
           'OLE_HANDLE', 'OLE_YSIZE_CONTAINER', 'IFontEventsDisp',
           'OLE_YSIZE_HIMETRIC', 'Checked', 'IFont',
           'OLE_XSIZE_HIMETRIC', 'Color', 'OLE_ENABLEDEFAULTBOOL',
           'IPictureDisp', 'IFontDisp', 'Gray', 'Font',
           'OLE_XPOS_CONTAINER']
